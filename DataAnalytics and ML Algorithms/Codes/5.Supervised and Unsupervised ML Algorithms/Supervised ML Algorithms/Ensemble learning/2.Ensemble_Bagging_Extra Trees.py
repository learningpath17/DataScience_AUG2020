...
#two key differences with RF: Extratrees does not bootstrap observations (meaning it samples without replacement), and nodes are split on random splits, not best splits.
...
titanic_test.to_csv("submission_ensemble_Extratrees-01.csv", columns=["PassengerId", "Survived"], index=False)
