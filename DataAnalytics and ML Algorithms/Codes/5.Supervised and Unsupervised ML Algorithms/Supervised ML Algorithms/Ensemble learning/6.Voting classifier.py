...
voting_estimator = ensemble.VotingClassifier(estimators=[('dt',dt_estimator), ('knn', knn_estimator), ('gnb',gnb_estimator), ('rf',rf_estimator)], voting='hard', weights = [1,1,1,2])
...
titanic_test.to_csv("submission_Ensemble_Voting_01.csv", columns=["PassengerId", "Survived"], index=False)
