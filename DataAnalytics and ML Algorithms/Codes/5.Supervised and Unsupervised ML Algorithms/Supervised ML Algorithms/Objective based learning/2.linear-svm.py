...
#linear svm
lsvm_estimator = svm.LinearSVC(random_state=100) # LinearSVC is Similar to SVC with parameter kernel=’linear’
...
titanic_test.to_csv("submission_LinearSVC.csv", columns=["PassengerId", "Survived"], index=False)